...
const ManageDeliveryBoy = ({ history }) => {
    ...
    useEffect(() => {
        // alert(params.id)
        // alert(JSON.stringify(singledeliveryboy))
        if (singledeliveryboy && singledeliveryboy.deliveryBoyId !== params.id) {
      ...
      }, [dispatch, alert, error, history, success,params.id,isUpdated,singledeliveryboy]);
