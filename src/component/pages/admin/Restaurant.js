...
const Restaurant = () => {
    ...
    const {
      ...
      const activedeactive = async (id, status) => {
        ...
        const result = await axios.put(`http://${process.env.REACT_APP_IP}/api/restaurant/${id}/${newstatus}`, '', '');
            ...
            <ThemeProvider theme={defaultMaterialTheme}>
              <MaterialTable
                ...
                columns={[
                  ...
                  { title: 'restaurantImage', field: 'imageUrl', render: rowData => <a href={`http://${process.env.REACT_APP_IP}${rowData.restaurantImage}`} target="_blank"><img src={`http://${process.env.REACT_APP_IP}${rowData.restaurantImage}`} alt="Cuisines Banner" style={{ width: 60, height: 30 }} /></a> },
