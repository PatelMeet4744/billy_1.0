...
const Home = () => {
    // alert(process.env.REACT_APP_IP);
                    ...
                    <div className="auth-form-light text-left" style={{ padding: '10% 10% 10% 10%' }}>
                        ...
                        <div style={{ marginTop: '8%' }}>
                            ...
                            <NavLink to="/admin/login">
                                ...
                                <a className="btn" style={{ textDecoration: 'none', color: '#f6881f', fontSize: 15 }} ><h3>Admin Portal</h3></a>
                        ...
                        <div style={{ marginTop: '3%' }}>
                            ...
                            <NavLink to="/partner/login">
                                <a className="btn" style={{ textDecoration: 'none', color: '#f6881f', fontSize: 15 }}><h3>Partner Portal</h3></a>
                            </NavLink>
                            </center>
                        </div>
